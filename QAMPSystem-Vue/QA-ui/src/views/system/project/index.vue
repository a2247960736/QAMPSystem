<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="业务ID" prop="projectId">
        <el-input
      ...
      <el-form-item label="所属部门ID" prop="deptId">
        <el-select v-model="queryParams.deptId" placeholder="请选择所属部门ID" clearable>
          <el-option
            v-for="dict in dict.type.sys_dept"
            :key="dict.value"
            :label="dict.label"
            :value="dict.value"
          />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="业务ID" prop="projectId">
          <el-input v-model="form.projectId" placeholder="请输入业务ID" />
        </el-form-item>
        <el-form-item label="所属部门ID" prop="deptId">
          <el-select v-model="form.deptId" placeholder="请选择所属部门ID">
            <el-option
              v-for="dict in dict.type.sys_dept"
              :key="dict.value"
              :label="dict.label"
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        deptId: [
          { required: true, message: "所属部门ID不能为空", trigger: "change" }
        ],
        projectName: [
