<template>
  <div class="box home-user-task-stats bgc1">
    <div class="header">
      <div class="title">
        项目统计<span class="sub-title">{{ start }} ~ {{ end }}</span>
      </div>
    </div>
    <div v-if="userTaskStats.length" class="body">
      <div class="stats">
        <div class="item">
          ...
          <div class="text color2">需求总数（个）</div>
        </div>
      </div>
      <div class="stats">
        <div class="item">
          ...
          <div class="text color2">测试计划总数（个）</div>
        </div>
      </div>
      <div class="stats">
        <div class="item">
          ...
          <div class="text color2">提测（个）</div>
        </div>
      </div>
      <div class="stats">
        <div class="item">
          ...
          <div class="text color2">打回（个）</div>
        </div>
      </div>
    </div>
  </div>
